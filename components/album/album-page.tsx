            ...
            inFlipBook ? (
              ...
              >
                <div className="relative">
                  ...
                  <span className="pointer-events-none absolute inset-x-0 bottom-0 z-20 rounded-b-[15px] bg-gradient-to-t from-verde-escuro-capa/90 to-transparent px-3 pb-3 pt-8 text-center text-[10px] font-bold uppercase tracking-wide text-white opacity-90 sm:text-xs">
                    Toque para alterar
                  </span>
                </div>
              </FlipBookLink>
